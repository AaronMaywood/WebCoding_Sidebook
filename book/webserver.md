...
無料で借りることもできますが、以下の点からおすすめできません。
...
- 36ヶ月一括：4,356円月額換算121円 "12ヶ月一括"より合計で1,584円お得！

```{tip}
**さくらのレンタルサーバーですか？...別にこだわる理由はありません**
...
````{hint}
`FTP`の練習をしたい場合には本書で推奨するさくらのレンタルサーバー・ライトプランを申し込んでおいてください。

```{hint}
**既ににお持ちの別の会社のサーバーでもかまいません**

ただし説明はさくらのレンタルサーバー・ライトプランに限定させていただきます。
```
````
...
- `URL`の頭 ... https://academy-php.sakura.ne.jp/
...
- 完成した`URL` ... https://academy-php.sakura.ne.jp/simplepage-master/index.html
