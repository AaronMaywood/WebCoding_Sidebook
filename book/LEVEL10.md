...
また、ポートフォリオを作成する国産の無料のWebサービスに「RESUME」があります。
- https://www.resume.id/
このサービスを使用してどんなポートフォリオが作成できるかは、実例リンク集である「https://www.resume.id/trends」から確認することができます。

いずれの方法にしても、使用するテンプレートに応じどこにどのような**画像や文章**が必要になるかの見当をつけて、それらの**素材を準備**しておく必要があります。
...
`HTML/CSS` コーダーの道は、ここまでが入り口です。
ここから先に何をするかが大きく将来に関わってきます。

今のみなさんにはまだまだ経験が足りていません。
ポートフォリオを盛るための作品の数が足りていないし、現場で求められるより高度な表現への対応についても学んでおいたほうが良いでしょう。

この章では今後学んでおきたいいくつかの情報の一例を記します。

```{hint}
紹介する記事はすぐに理解できるものから、現場で１〜２年と経験を積んでからでないと難しい高度なことまでが含まれます。
全てを完璧に読むことはできませんので、どの記事を読んでどの記事を後回しにするかをご自身で判断しながらお読み下さい。
```

## コーディング学習用の無料のデザインカンプ

Google検索で「[無料 デザインカンプ](https://www.google.com/search?q=%E7%84%A1%E6%96%99+%E3%83%87%E3%82%B6%E3%82%A4%E3%83%B3%E3%82%AB%E3%83%B3%E3%83%97&oq=%E7%84%A1%E6%96%99%E3%80%80%E3%83%87%E3%82%B6%E3%82%A4%E3%83%B3%E3%82%AB%E3%83%B3%E3%83%97&aqs=chrome..69i57j0i8i30i625l4.6046j1j7&sourceid=chrome&ie=UTF-8)」などのキーワードで検索をしてみてください。ポートフォリオに掲載OKという許諾付きのデザインカンプがいくつか見つかります。
もちろん、有料のものもあります。

これらの配付素材をもとにコーディングし、ポートフォリオに盛り込みましょう。

% https://code-step.com/#coding-all いくつか無料コーディング教材がある

## ページ上の部品

近年のウェブサイトには、ページの最初に戻ることのできる便利なボタンや細部のちょっとしたアニメーションの演出など、気の利いた仕組みを付けることが普通になりました。

- [動くWebデザインアイディア帳](https://coco-factory.jp/ugokuweb/)
	さまざまな動くデザインを紹介しています。HTML/CSSのコードもありますので、その作り方を学んで見て下さい。
	（JavaScript、jQueryといったプログラム技術が必要とされるものも含まれていますが、`HTML/CSS` だけでできるものも多数あります）

## ジェネレーター

画面上で操作した結果をそのまま`HTML`や`CSS`のコードとして取得できる「ジェネレータ（`HTML/CSS`の生成器）」とよばれるツールがあります。これを利用するとコーディングの生産性が向上します。

- https://web-generates.com/
- https://sdesignlabo.com/web/css-generator/

## 押さえておきたい！情報源

表現のトレンドを知る、`CSS`の最新情報を知る、よい手法に詳しくなるなどの理由で、日頃から情報集種を欠かさないようにしましょう。

以下は推薦できる情報源です。

- https://coliss.com/
	海外情報の翻訳を中心に様々な観点からの幅広い記事が満載です。
- https://ics.media/entry/category/html5/
	具体例が豊富、現場でのノウハウが凝縮した濃い中身の役立つ記事ばかりです。

## ここで紹介したことは「一例」です

以上、いくつかの情報源を紹介しましたが、ウェブを探すと多くの様々な記事がすぐに見つかります。
「もっと初心者向けの噛み砕いた情報が欲しい」「新しいCSSプロパティには何があるか？」など、必要に応じて自ら検索し、`HTML/CSS`コーダーの道を深めて行って下さい。

`HTML/CSS` の世界は非常に奥深いものとなっており、学ぶべきこと、学べることは数限りなくあります。大変であると同時に、人生を傾けてまで学ぶ価値のある、やりがいのある専門職です。
一日、一日、できることを増やすという観点から、これからも学習を続けて下さい。
