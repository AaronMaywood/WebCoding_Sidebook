...
|:---|:---|:---|:---|:---|
|UXコア体験の読み合わせ、このカリキュラムを受講する場合のポイント、昇段試験の提供方法や退校や就職支援、事務局運営について|{{TODO}}|-|-|{{TODO}}|
|LEVEL10.md 卒業制作|{{DONE}}|-|-|{{TODO}}|
|LEVEL10.md ポートフォリオ制作|{{HALF}}（作例の提供はせず、生徒の優れたものを使わせてもらう）|-|-|{{TODO}}|
|intro.md|{{DONE}}|-|-|{{TODO}}|
|ユーザーサポートを受ける説明を作る jitsi meeting?|{{TODO}}|-|-|{{TODO}}|
|フィードバック反映|{{HALF}}|-|-|{{TODO}}|
|アジャバイト制作物採点|{{TODO}}|{{TODO}}|{{TODO}}|{{TODO}}|
|リリースに向けた細々した作業|{{TODO}}|-|-|{{TODO}}|
|Gridレイアウト|{{TODO}}|{{TODO}}|{{TODO}}|{{TODO}}|
|昇段テストの解答には62.5%のテクニックを使っていないことを説明するか、62.5%を使うように改訂すること LV3,LV4|{{DONE}}|-|-|{{TODO}}|
